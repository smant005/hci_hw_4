     ...
     <div class="navbar-header">
         <div class="d-flex">
             ...
             <div class="navbar-brand-box">
                 <a href="/Recwell-PHP" class="logo logo-dark">
                     <span class="logo-sm">
                         <img src="assets/images/logo-sm.svg" alt="" height="30">
                     </span>
                     <span class="logo-lg">
                         <img src="assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">Recwell</span>
                     </span>
                 </a>

                 <a href="/Recwell-PHP" class="logo logo-light">
                     <span class="logo-sm">
                         <img src="assets/images/logo-sm.svg" alt="" height="30">
                     </span>
                     <span class="logo-lg">
             ...
             <div class="collapse navbar-collapse" id="topnav-menu-content">
                 <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle arrow-none" href="/Recwell-PHP" id="topnav-dashboard" role="button">
