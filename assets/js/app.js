/*
Template Name: Recwell - Bootstrap 5 Admin & Dashboard Template
Author: Themesdesign
Version: 1.2.0.
...
(function ($) {
    ...
    var language = localStorage.getItem('Recwell-language');
    // Default Language
    var default_lang = 'en';
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            ...
            localStorage.setItem('Recwell-language', lang);
            language = localStorage.getItem('Recwell-language');
            getLanguage();
        }
    }
