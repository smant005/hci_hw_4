         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0 font-size-18">Stuios</h4>
               </div>
            </div>
         </div>
         <!-- end page title -->
                  ...
                  <div class="card-body">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-1 ms-3">
                              <h5 class="font-size-15 mb-1"><a href="#" class="text-dark">Yoga</a><span class="dot bg-success"></span></h5>
               ...
               <div class="card">
                  <div class="card-body">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-1 ms-3">
                              <h5 class="font-size-15 mb-1"><a href="#" class="text-dark">Zuma</a><span class="dot bg-success"></span></h5>
                              <p class="text-muted mb-0">Recreation Center</p>
                           </div>
                        </div>
                        <div class="mt-3 pt-1">
               ...
               <div class="card">
                  <div class="card-body">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-1 ms-3">
                              <h5 class="font-size-15 mb-1"><a href="#" class="text-dark">Taekwondo </a><span class="dot bg-success"></span></h5>
                              <p class="text-muted mb-0">Recreation Center</p>
                           </div>
                        </div>
                        <div class="mt-3 pt-1">
               ...
               <div class="card">
                  <div class="card-body">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-1 ms-3">
                              <h5 class="font-size-15 mb-1"><a href="#" class="text-dark">Karate</a><span class="dot bg-success"></span></h5>
                              <p class="text-muted mb-0">Recreation Center</p>
                           </div>
                        </div>
                        <div class="mt-3 pt-1">
               ...
               <div class="card">
                  <div class="card-body">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-1 ms-3">
                              <h5 class="font-size-15 mb-1"><a href="#" class="text-dark">Dance</a><span class="dot bg-success"></span></h5>
                              <p class="text-muted mb-0">Recreation Center</p>
                           </div>
                        </div>
                        <div class="mt-3 pt-1">
