...
option = {
    ...
    color: mixlinebarColors, //['#003057', '#003057', '#fd625e'],
    legend: {
...
option = {
    ...
    color: doughnutColors, //['#003057', '#ffbf53', '#fd625e', '#4ba6ef', '#003057'],
    series: [
        {
            name:'Total sales',
            type:'pie',
...
option = {
    ...
    color: pieColors, //['#fd625e', '#003057', '#4ba6ef', '#ffbf53', '#003057'],
    series : [
        {
            name: 'Total sales',
            type: 'pie',
